...
) ENGINE=InnoDB AUTO_INCREMENT=130024 DEFAULT CHARSET=latin1
...
CREATE TABLE `aruba_iap_device_info_archive` (
  ...
  PRIMARY KEY (`id`,`poll_time`)
) ENGINE=InnoDB AUTO_INCREMENT=2019509 DEFAULT CHARSET=latin1
/*!50100 PARTITION BY RANGE (year(`poll_time`))
(PARTITION p2025 VALUES LESS THAN (2025) ENGINE = InnoDB,
 PARTITION p2026 VALUES LESS THAN (2026) ENGINE = InnoDB,
 PARTITION p2027 VALUES LESS THAN (2027) ENGINE = InnoDB,
...
CREATE TABLE `aruba_iap_wlan_traffic_archive` (
  ...
  PRIMARY KEY (`id`,`poll_time`)
) ENGINE=InnoDB AUTO_INCREMENT=370385 DEFAULT CHARSET=latin1
/*!50100 PARTITION BY RANGE (year(`poll_time`))
(PARTITION p2025 VALUES LESS THAN (2025) ENGINE = InnoDB,
 PARTITION p2026 VALUES LESS THAN (2026) ENGINE = InnoDB,
 PARTITION p2027 VALUES LESS THAN (2027) ENGINE = InnoDB,
...
) ENGINE=InnoDB AUTO_INCREMENT=53 DEFAULT CHARSET=latin1 COMMENT='for iface table, name means wifi essid string (if detected), if no essid detected, use iface_phy_name (eth0,eth1)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `rfc1213_iftable_traffic_archive` (
  ...
  PRIMARY KEY (`id`,`poll_time`)
) ENGINE=InnoDB AUTO_INCREMENT=1973692 DEFAULT CHARSET=latin1
/*!50100 PARTITION BY RANGE (year(`poll_time`))
(PARTITION p2025 VALUES LESS THAN (2025) ENGINE = InnoDB,
 PARTITION p2026 VALUES LESS THAN (2026) ENGINE = InnoDB,
 PARTITION p2027 VALUES LESS THAN (2027) ENGINE = InnoDB,
...
) ENGINE=InnoDB AUTO_INCREMENT=39223 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-08-03 23:05:24
